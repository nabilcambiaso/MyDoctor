          ...
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              @if (Route::has('login'))
                  ...
                  @auth
              <li><div class="gradient-button"><a id="modal_trigger" href="{{ route('dashboard') }}"><i class="fa fa-user-md"></i> Dashboard</a></div></li> 

                  @else
              <li><div class="gradient-button"><a id="modal_trigger" href="{{ route('login') }}"><i class="fa fa-sign-in-alt"></i> Sign In Now</a></div></li> 

                      @if (Route::has('register'))
              <li><div class="gradient-button"><a id="modal_trigger" href="{{ route('register') }}"><i class="fa fa-user-plus"></i> Register</a></div></li> 
